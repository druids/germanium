...
BTN_SAVE_AND_CONTINUE = getattr(
    settings, "BTN_SAVE_AND_CONTINUE", ".btn-save-and-continue"
)
...
SELENIUM_DISPLAY_DIMENSION = getattr(
    settings, "SELENIUM_DISPLAY_DIMENSION", (1440, 900)
)
